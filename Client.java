...
public class Client extends JFrame{
    ...
    private void startClient() {
        // connect to server, get streams and start output thread
        try {
    ...
    private void processMessages(String message) {
        if(message.equals("Player number is")) {
            ...
            switch(playerNumber) { // displays player number and colour of token on messageBox
            ...
            switch(playerNumber) { // display player number and start the game message
            ...
            if(!gameOver) { // can roll until game is over
                ...
                switch(playerNumber) { // display the turn of the player
    ...
    private void rollDice() throws InterruptedException
    {
        if(myTurn) { // check for my turn
            switch(playerNumber) { // display waiting message
